...
const SettingsScreen::ThemeOption SettingsScreen::_options[3] = {
    { "Emerald (зелений)",  BG_EMERALD, TFT_COLOR(6,10,7) },
    { "Чорний",            BG_BLACK,   TFT_COLOR(0,0,0) },
    { "Темно-фіолетовий",  BG_PURPLE,  TFT_COLOR(30,10,50) },
...
void SettingsScreen::draw() {
    ...
    drawHeader("НАЛАШТУВАННЯ", true);


    tft.setTextColor(COLOR_NEON, COLOR_BLACK);
    tft.setTextSize(1);
    tft.drawString("Тема фону:", 10, HEADER_HEIGHT + 10, 2);
    ...
    drawStatusBarType("ТАП ЩОБ ВИБРАТИ", COLOR_YELLOW);
...
void SettingsScreen::drawCalibrateButton() {
    ...
    tft.drawString(">> Калібрувати Touch <<", x + 12, y + CALIB_H / 2, 2);
