...
const MenuScreen::MenuTile MenuScreen::_tiles[MENU_TILE_COUNT] = {
    { "[USR]", "My Profile",     "Level, achievements"    },   // 0
    { "[MAP]", "My Missions",    "Full learning timeline" },   // 1
    { "[WIF]", "Wi-Fi",           "WiFi + Bluetooth"       },   // 2
    { "[SET]", "Settings",       "Background, theme"      },   // 3
    { "[GAM]", "Mini Games",     "Snake, Space Shooter"   },   // 4
    { "[TMR]", "System Console", "Terminal, commands"     },   // 5
    { "[MSG]", "From Family",    "Message from parents"   },   // 6
};
